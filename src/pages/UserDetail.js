...
const items = [
  ...
  return (
    <div className="userDetail">
      <Row>
        <Col xs={24} sm={24} md={24} lg={4} xl={4} className="bg-[--secondary-color] py-16"></Col>
        <Col
      ...
      <Row className="m-4">
        ...
        <Col xs={24} sm={24} md={24} lg={8} xl={8}>
          <p className="pe-0 lg:pe-8 pb-4 lg:pb-0 text-base text-[--secondary-color]">
            ...
            culpa qui officia deserunt mollit anim id est laborum. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <div className="bg-[--secondary-color] m-4 p-4 lg:p-10">
        <div className="text-3xl font-bold text-[--primary-color] jobHead relative">Job Functions & Efficiency</div>
        <div className="grid gird-col-1 lg:grid-cols-3 gap-y-4 gap-x-16 mt-10">
          <div className="flex justify-between">
            <div className="text-xl font-semibold text-white">Art and Design</div>
      ...
      <div className="grid grid-col-1 lg:grid-cols-2 m-4 personalDetail">
        <div className="p-2 lg:p-8 borderRight">
          <Collapse 
            size="large"
            bordered={false}
            accordion 
